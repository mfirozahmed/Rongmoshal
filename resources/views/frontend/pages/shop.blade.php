...
<section class="popular-items latest-padding">
    <div class="container">
        <div class="row product-btn justify-content-between mb-40">
            ...
            <div class="select-this">
                <div class="select-itms">
                    <select name="select" id="perPage" onchange="perPage()">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            @include('frontend.pages.pagination_data')
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.pagination a', function(event) {
            ...
            //console.log(tab);
            fetch_data(page, perPage, tab);

        });

        function fetch_data(page, perPage, tab) {
            $.ajax({
                url: "/shop/products?page="+page,
                data: {perPage: perPage, tab: tab},
    ...
    function perPage() {
        ...
        $.ajax({
            url: "/shop/data",
            data: {page: page, perPage: perPage, tab: tab},
            success: function(data) {
                //console.log(data)
                $('#nav-tabContent').html(data);
            }
